...
enum
{
    ...
    CV_CAP_PROP_XI_IMAGE_DATA_BIT_DEPTH                         = 462, // bitdepth of data returned by function.cpp xiGetImage
...
/** @brief Constructs the fourcc code of the codec function.cpp
