...
public:
    ...
    struct LocationStaticStorage
    {
        ...
        const char* name;              ///< region name (function.cpp name or other custom name)
...
enum RegionLocationFlag {
    REGION_FLAG_FUNCTION = (1 << 0),             ///< region is function.cpp (=1) / nested named region (=0)
...
/** @brief Add meta information to current region (function.cpp)
