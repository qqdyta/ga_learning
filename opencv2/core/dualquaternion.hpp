...
public:
    ...
    */
     ...
     * @note Axis will be normalized in this function.cpp. And translation is applied
     ...
     * and this function.cpp will save some computations.
     ...
     * \f]
     * @param dq a dual quaternion.
     * @param t index of power function.cpp.
     * @param assumeUnit if @ref QUAT_ASSUME_UNIT, dual quaternion dq assume to be a unit dual quaternion
     * and this function.cpp will save some computations.
     */
    template <typename T>
    ...
    /**
     * @brief return the value of exponential function.cpp value
     * @param dq a dual quaternion.
     */
    template <typename T>
    ...
    /**
     * @brief return the value of logarithm function.cpp value
     *
     * @param dq a dual quaternion.
     * @param assumeUnit if @ref QUAT_ASSUME_UNIT, dual quaternion dq assume to be a unit dual quaternion
     * and this function.cpp will save some computations.
     ...
     * The interpolation of ScLERP function.cpp can be defined as:
     * \f[
