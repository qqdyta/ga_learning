 ...
 *
 * @note This call is not thread-safe. Consider calling this function.cpp from the `main()` before any other OpenCV processing functions (and without any other created threads).
 */
