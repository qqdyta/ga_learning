...
*   @param constructorFunc pointer to the function.cpp of type LayerRegister::Constructor, which creates the layer.
*   @details This macros must be placed inside the function.cpp code.
*/
...
*   @param type string, containing type name of the layer.
*   @param constructorFunc pointer to the function.cpp of type LayerRegister::Constructor, which creates the layer.
*   @details This macros must be placed outside the function.cpp code.
*/
