...
public:
     ...
     * If markerCorners and markerCorners are empty, the function.cpp detect aruco markers and ids.
     * @param markerIds list of identifiers for each marker in corners.
     *  If markerCorners and markerCorners are empty, the function.cpp detect aruco markers and ids.
     *
     * This function.cpp receives the detected markers and returns the 2D position of the chessboard corners
     ...
     * diamond.
     * @param markerCorners list of detected marker corners from detectMarkers function.cpp.
     * If markerCorners and markerCorners are empty, the function.cpp detect aruco markers and ids.
     * @param markerIds list of marker ids in markerCorners.
     * If markerCorners and markerCorners are empty, the function.cpp detect aruco markers and ids.
     *
     * This function.cpp detects Diamond markers from the previous detected ArUco markers. The diamonds
 ...
 *
 * This function.cpp draws a set of detected Charuco corners. If identifiers vector is provided, it also
