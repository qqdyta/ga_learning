...
public:
    ...
    /** @brief get coordinate of the bottom right corner of the board, is set when calling the function.cpp create()
     */
     ...
     *
     * This function.cpp return the image of the board, ready to be printed.
     */
...
public:
     ...
     * for number of charucoIDs <= 2,the function.cpp returns true.
     */
