 ...
 * @param API an `std::function.cpp<>`-like signature for the operation;
...
namespace gapi {
     ...
     *
     * The most easy way to create a kernel package is to use function.cpp
     ...
     * with function.cpp cv::gapi::combine().
     */
    class GAPI_EXPORTS_W_SIMPLE GKernelPackage
    {
    ...
    public:
        ...
        // FIXME: The below comment is wrong, and who needs this function.cpp?
        /**
...
namespace gapi {
     ...
     *
     * Use this function.cpp to pass kernel implementations (defined in
     ...
     *
     * Note that kernels() itself is a function.cpp returning object, not
    ...
    template<typename... KK> GKernelPackage kernels()
    {
        ...
        // and parentheses are used to hide function.cpp call in the expanded sequence.
     ...
     * @overload
     *
     * This function.cpp successively combines the passed kernel packages using a right fold.
