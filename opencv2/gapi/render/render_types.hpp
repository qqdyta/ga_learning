...
struct GAPI_EXPORTS_W_SIMPLE Rect
{
     ...
     * @param thick_  The thickness of lines that make up the rectangle. Negative values, like #FILLED, mean that the function.cpp has to draw a filled rectangle
    ...
    GAPI_PROP_RW int        thick; //!< The thickness of lines that make up the rectangle. Negative values, like #FILLED, mean that the function.cpp has to draw a filled rectangle
