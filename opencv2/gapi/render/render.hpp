...
//! @{
/** @brief The function.cpp renders on the input image passed drawing primitivies
...
/** @brief The function.cpp renders on two NV12 planes passed drawing primitivies
...
/** @brief The function.cpp renders on the input media frame passed drawing primitivies
