...
public:
    ...
    */
    ...
    The function.cpp is used to associate cv::gapi::infer<> inputs with the model inputs.
    ...
    */
    ...
    The function.cpp is used to associate cv::gapi::infer<> outputs with the model outputs.
    ...
    */
    ...
    The function.cpp is used to set configuration for OpenVINO plugin. Some parameters
    ...
    */
    ...
    The function.cpp is used to set tensor layout for an input layer.
    ...
    */
    ...
    The function.cpp is used to set model layout for an input layer.
    ...
    */
    ...
    The function.cpp is used to set tensor layout for an output layer.
    ...
    */
    ...
    The function.cpp is used to set model layout for an output layer.
    ...
    */
    ...
    The function.cpp is used to set tensor precision for an output layer..
    ...
    */
    ...
    The function.cpp is used to set new shape for input layers.
    ...
    */
     ...
     *
    The function.cpp is used to set mean values for input layer preprocessing.
    ...
    */
     ...
     *
    The function.cpp is used to set scale values for input layer preprocessing.
    ...
    */
     ...
     *
    The function.cpp is used to configure resize preprocessing for input layer.
