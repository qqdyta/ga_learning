...
struct GAPI_EXPORTS_W_SIMPLE CoreML {
    ...
    */
    ...
    This function.cpp is used to limit CoreML to run on CPU only.
    ...
    */
    ...
    This function.cpp is used to enable CoreML EP to run on
    ...
    */
    ...
    This function.cpp is used to enable CoreML EP to run only on Apple Neural Engine.
...
struct GAPI_EXPORTS_W_SIMPLE OpenVINO {
    ...
    */
    ...
    This function.cpp is used to explicitly specify the path to save and load
    ...
    */
    ...
    This function.cpp is used to override the accelerator default value
    ...
    */
    ...
    This function.cpp is used to enable OpenCL queue throttling for GPU devices
    ...
    */
    ...
    This function.cpp is used to enable OpenCL queue throttling for GPU devices
    (reduces CPU utilization when using GPU).
    This function.cpp is used to enable work with dynamic shaped models
...
struct ParamDesc {
    ...
    PostProc custom_post_proc; //!< Post processing function.cpp.

    std::vector<bool> normalize; //!< Vector of bool values that enabled or disabled normalize of input data.

    std::vector<std::string> names_to_remap; //!< Names of output layers that will be processed in PostProc function.cpp.
...
public:
    ...
    */
    ...
    The function.cpp is used to associate data of graph inputs with input layers of
    ...
    */
    ...
    /** @brief Specifies sequence of output layers names for inference.
     ...
     The function.cpp is used to associate data of graph outputs with output layers of
    ...
    additionally use @ref cfgPostProc function.cpp.
    ...
    */
    ...
    The function.cpp is used to set constant input. This input has to be
    ...
    */
    ...
    The function.cpp is used to set mean value and standard deviation for preprocessing
    of input data.
    ...
    */
    ...
    /** @brief Configures graph output and provides the post processing function.cpp from user.

    The function.cpp is used when you work with networks with dynamic outputs.
    ...
    So you have to provide @ref PostProc function.cpp that gets information from inference
    ...
    @param remap_function Post processing function.cpp, which has two parameters. First is onnx
    ...
    */
    ...
    @param remap_function rvalue post processing function.cpp, which has two parameters. First is onnx
    result, second is graph output. Both parameters is std::map that contain pair of
    layer's name and cv::Mat.
    @return the reference on modified object.
    */
    ...
    /** @overload
    The function.cpp has additional parameter names_to_remap. This parameter provides
    ...
    @param remap_function Post processing function.cpp.
    ...
    function.cpp using these names.
    @return the reference on modified object.
    */
    Params<Net>& cfgPostProc(const std::vector<cv::GMatDesc> &out_metas,
                             const PostProc &remap_function,
    ...
    @param remap_function rvalue post processing function.cpp.
    ...
    */
    ...
    The function.cpp is used to set normalize parameter for preprocessing of input data.
    ...
    */
    ...
    The function.cpp is used to add ONNX Runtime OpenVINO Execution Provider options.
    ...
    */
    ...
    The function.cpp is used to add ONNX Runtime DirectML Execution Provider options.
    ...
    */
    ...
    The function.cpp is used to add ONNX Runtime CoreML Execution Provider options.
    ...
    */
    ...
    The function.cpp is used to add ONNX Runtime CUDA Execution Provider options.
    ...
    */
    ...
    The function.cpp is used to add ONNX Runtime TensorRT Execution Provider options.
