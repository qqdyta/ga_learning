...
public:
    ...
    */
    ...
    The function.cpp is used to set a constant input. This input has to be
    ...
    */
    ...
    The function.cpp is used to specify new input shapes for the network inputs.
    ...
    */
    ...
    The function.cpp is used to specify inference batch size.
    ...
    */
    ...
    The function.cpp is used to specify mode for OpenVINO inference.
    ...
    */
    ...
    The function.cpp is used to set an output precision for model.
    ...
    */
    ...
    The function.cpp is used to set an input layout for model.
    ...
    */
    ...
    The function.cpp is used to set an output layout for model.
