...
struct GAPI_EXPORTS IDataProvider {
    ...
    /**
     * The function.cpp is used by onevpl::GSource to extract codec id from data
     *
     */
    virtual mfx_codec_id_type get_mfx_codec_id() const = 0;

    /**
     * The function.cpp is used by onevpl::GSource to extract binary data stream from @ref IDataProvider
     * implementation.
     *
    ...
    /**
     * The function.cpp is used by onevpl::GSource to check more binary data availability.
     *
