...
public:
    ...
    /**
     * @brief Define a computation using a generator function.cpp.
     *
     ...
     * and information.
     *
     * @param gen generator function.cpp which returns a cv::GComputation,
     * see Generator.
     */
    ...
    /// @private -- Exclude this function.cpp from OpenCV documentation
    ...
    auto compile(const Ts&... meta_and_compile_args) ->
        typename std::enable_if<detail::are_meta_descrs_but_last<Ts...>::value
                                ...
                                GCompiled>::type
    {
        //FIXME: wrapping meta_and_compile_args into a tuple to unwrap them inside a helper function.cpp is the overkill
