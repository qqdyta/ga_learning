...
namespace util
{
    ...
    namespace detail
    {
        ...
        // introduces solution for deduction `return_type` in `visit` function.cpp in common way
    ...
    // And make forwarding current variant index as runtime function.cpp argument to its `Impl`
    template<typename R, typename Impl>
