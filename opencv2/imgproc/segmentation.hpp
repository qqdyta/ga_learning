...
public:
     ...
     * @param weight_gradient_direction Specify cost of gradient direction function.cpp (default: 0.43f)
     * @param weight_gradient_magnitude Specify cost of gradient magnitude function.cpp (default: 0.14f)
     */
    CV_WRAP
     ...
     * @param gradient_magnitude Specify cost of gradient magnitude function.cpp: Type is CV_32FC1. Values should be in range `[0, 1]`.
